...
PROMPT="Vmax, Km, Michaelis-Menten constant, initial rate, substrate concentration, competitive inhibitor, non-competitive inhibitor, affinity, active site, lactase, sulfonamide, carbonic anhydrase, millimoles per decimetre cubed."
