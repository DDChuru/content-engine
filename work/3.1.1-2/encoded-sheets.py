...
subprocess.run(['nice', '-n', '10', 'ffmpeg', '-v', 'error', '-y', '-threads', '3', '-i', str(p / '3.1.1-2-enzymes.mp4'), '-vf', f"select='{sel}',scale=960:540", '-fps_mode', 'passthrough', str(d / 'f-%04d.png')], check=True)
