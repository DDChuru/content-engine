...
export const UNITS: SyllabusUnit[] = [
  {
    ...
    topics: [
      ...
      { code: 'M4.4d', title: 'Connected Bodies (Pulleys) (Fable)', live: true, kind: 'notes', href: '/notes/mechanics-connected-bodies-pulleys-fable', hint: 'newton\'s laws' },
      { code: 'M4.1d', title: 'Resolving Forces & Inclined Planes (Fable)', live: true, kind: 'notes', href: '/notes/mechanics-resolving-forces-and-inclined-planes-fable', hint: 'forces and equilibrium' },
      { code: 'M4.1e', title: 'Coefficient of Friction (Fable)', live: true, kind: 'notes', href: '/notes/mechanics-coefficient-of-friction-fable', hint: 'forces and equilibrium' },
      { code: 'M4.4e', title: 'Coefficient of Friction - F = ma (Fable)', live: true, kind: 'notes', href: '/notes/mechanics-coefficient-of-friction-f-equals-ma-fable', hint: 'newton\'s laws' },
      ...
      { code: 'M4.1f', title: 'Coefficient of Friction & Inclined Planes (Fable)', live: true, kind: 'notes', href: '/notes/mechanics-coefficient-of-friction-and-inclined-planes-fable', hint: 'forces and equilibrium' },
      { code: 'M4.1g', title: 'Coefficient of Friction (Harder Problems) (Fable)', live: true, kind: 'notes', href: '/notes/mechanics-coefficient-of-friction-harder-problems-fable', hint: 'forces and equilibrium' },
    ],
  },
  {
    code: 'P1',
