/**
 * Faceless Content Creator - AI Video Director
 * Ported from Next.js to Vite React for Content Engine Studio
 *
 * Features:
 * - Company research and interview workflow
 * - Voice recording and transcription
 * - AI-powered storyboard generation
 * - Image generation with Gemini
 * - Narration generation with TTS
...
interface FacelessCreatorProps {
  onContextUpdate?: (context: {
    workspace: 'faceless-creator';
    selection?: unknown;
...
export default function FacelessCreator({ onContextUpdate }: FacelessCreatorProps) {
  // Step state
