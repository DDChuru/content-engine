...
class AngleatCentre(Scene):
    def construct(self):
        ...
        angle_centre_label = Text("100", font_size=24, color=RED).next_to(angle_centre, RIGHT, buff=0.2)
        ...
        angle_circum_label = Text("50", font_size=24, color=ORANGE).next_to(angle_circum, UP, buff=0.2)
        ...
        explanation = VGroup(
            ...
            Text("100 = 2 x 50", font_size=24, color=YELLOW)
