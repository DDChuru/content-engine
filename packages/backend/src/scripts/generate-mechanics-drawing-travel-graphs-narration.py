#!/usr/bin/env python3
"""Generate Drawing Travel Graphs narration with exact inserted-silence holds."""
...
def scenes():
    source=(ROOT/'packages/backend/projects/mechanics-drawing-travel-graphs/STORYBOARD.md').read_text()
    result=[]
...
def generate(scene):
    ...
    target=AUDIO/f"drawing-travel-graphs-{scene['id']}.mp3"
