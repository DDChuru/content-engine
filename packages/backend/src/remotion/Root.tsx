...
export const RemotionRoot: React.FC = () => {
  ...
  return (
    <>
      ...
      <Composition
        id="MechanicsScalarsVectors"
        component={MechanicsScalarsVectors}
        durationInFrames={mechanicsScalarsVectorsDuration}
        fps={fps}
        width={1920}
        height={1080}
        defaultProps={{
      ...
      <Composition
        id="MechanicsDerivedUnits"
        component={MechanicsDerivedUnits}
        durationInFrames={mechanicsDerivedUnitsDuration}
        fps={fps}
        width={1920}
        height={1080}
        defaultProps={{
          audioEnabled: true,
        } satisfies MechanicsDerivedUnitsProps}
      />

      <Composition
        id="MechanicsTypesOfForces"
        component={MechanicsTypesOfForces}
        durationInFrames={mechanicsTypesOfForcesDuration}
        fps={fps}
        width={1920}
        height={1080}
        defaultProps={{
          audioEnabled: true,
        } satisfies MechanicsTypesOfForcesProps}
      />
      ...
      />
      <Composition
        id="MechanicsSuvatIn1D"
        component={MechanicsSuvatIn1D}
        durationInFrames={getMechanicsSuvatIn1DDuration(30)}
        fps={30}
        width={1920}
        height={1080}
