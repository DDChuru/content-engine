/** Topic-local copy of mechanics-m42/Ink.tsx for the Fable Coefficient of Friction lesson; adds the uppercase X glyph only. */
...
const G: Record<string, Glyph> = {
  ...
  '±': { width: .7, strokes: [[[.34,.06],[.34,.62]], [[.04,.34],[.65,.34]], [[.04,.88],[.65,.88]]] },
  ...
  ",": {width: .4, strokes: [[[0.22, 0.86], [0.24, 0.9], [0.14, 1.08]]]},
  ' ': { width: .36, strokes: [] },
};


Object.assign(G, {
  // Energy symbols and joule units for the work/energy lessons.
  'E': {width:.78,strokes:[[[.7,.04],[.08,.04],[.08,.96],[.72,.96]],[[.08,.49],[.61,.49]]]},
  'K': {width:.82,strokes:[[[.08,.04],[.08,.96]],[[.74,.04],[.08,.59],[.77,.96]]]},
  'J': {width:.76,strokes:[[[.15,.04],[.67,.04]],[[.58,.04],[.58,.76],[.47,.94],[.23,.96],[.07,.8]]]},
  'G': {width:.87,strokes:[[[.77,.15],[.52,.04],[.24,.1],[.08,.34],[.07,.7],[.23,.91],[.53,.96],[.77,.8],[.77,.54],[.48,.54]]]},
  // Actual friction and its limiting value use distinct symbols.
  'μ': {width:.8,strokes:[[[.12,.25],[.07,1.22]],[[.11,.55],[.17,.85],[.34,.95],[.61,.71],[.65,.25],[.61,.86],[.73,.95]]]},
  '≤': {width:.75,strokes:[[[.64,.08],[.1,.4],[.64,.71]],[[.09,.94],[.66,.94]]]},
  '<': {width:.75,strokes:[[[.64,.16],[.1,.54],[.64,.92]]]},
  'x': {width:.75,strokes:[[[.08,.25],[.64,.94]],[[.64,.25],[.08,.94]]]},
  // Components and angle notation for resolving-force working.
  'H': {width:.82,strokes:[[[.07,.04],[.07,.96]],[[.74,.04],[.74,.96]],[[.07,.49],[.74,.49]]]},
  'V': {width:.84,strokes:[[[.04,.04],[.41,.96],[.8,.04]]]},
  'P': {width:.8,strokes:[[[.08,.96],[.08,.04],[.51,.04],[.69,.2],[.63,.44],[.08,.49]]]},
  'X': {width:.78,strokes:[[[.06,.04],[.7,.96]],[[.7,.04],[.06,.96]]]},
  'Q': {width:.86,strokes:[[[.4,.04],[.17,.12],[.06,.39],[.1,.76],[.29,.94],[.56,.94],[.74,.71],[.75,.34],[.6,.08],[.4,.04]],[[.46,.71],[.82,1.08]]]},
  'θ': {width:.76,strokes:[[[.37,.04],[.16,.13],[.07,.43],[.11,.77],[.29,.96],[.52,.9],[.68,.61],[.66,.25],[.52,.05],[.37,.04]],[[.1,.49],[.66,.48]]]},
  '°': {width:.42,strokes:[[[.21,.02],[.08,.07],[.04,.2],[.11,.32],[.25,.34],[.36,.23],[.34,.09],[.21,.02]]]},
  '√': {width:.88,strokes:[[[.03,.55],[.2,.46],[.38,.96],[.64,.04],[.84,.04]]]},
  '⊥': {width:.7,strokes:[[[.35,.24],[.35,.88]],[[.06,.88],[.64,.88]]]},
  '∥': {width:.54,strokes:[[[.12,.08],[.12,.94]],[[.43,.08],[.43,.94]]]},
  // Force-diagram labels use the same pen geometry as the mechanics working.
  'W': {width:1.05,strokes:[[[.03,.04],[.23,.96],[.52,.36],[.79,.96],[1.01,.04]]]},
  'M': {width:1.0,strokes:[[[.06,.96],[.06,.04],[.49,.61],[.93,.04],[.93,.96]]]},
  'N': {width:.86,strokes:[[[.07,.96],[.07,.04],[.77,.96],[.77,.04]]]},
  'R': {width:.8,strokes:[[[.08,.96],[.08,.04],[.51,.04],[.69,.2],[.63,.44],[.08,.49]],[[.37,.49],[.76,.96]]]},
  'T': {width:.8,strokes:[[[.03,.06],[.76,.06]],[[.4,.06],[.4,.96]]]},
  'F': {width:.75,strokes:[[[.1,.96],[.1,.04],[.7,.04]],[[.1,.48],[.61,.48]]]},
  'B': {width:.8,strokes:[[[.08,.96],[.08,.04],[.49,.04],[.68,.2],[.56,.45],[.08,.47]],[[.37,.47],[.66,.57],[.71,.79],[.52,.96],[.08,.96]]]},
  'A': {width:.8,strokes:[[[.03,.96],[.38,.04],[.76,.96]],[[.17,.63],[.61,.63]]]},
  'k': {width:.75,strokes:[[[.1,.02],[.1,.96]],[[.65,.27],[.1,.65],[.67,.96]]]},
  'ₚ': {width:.45,strokes:[[[.06,1.14],[.06,.55],[.28,.55],[.39,.68],[.3,.83],[.06,.82]]]},
  ...
  '≈': {width:.7,strokes:[[[.06,.42],[.2,.32],[.36,.4],[.52,.46],[.64,.36]],[[.06,.7],[.2,.6],[.36,.68],[.52,.74],[.64,.64]]]},
