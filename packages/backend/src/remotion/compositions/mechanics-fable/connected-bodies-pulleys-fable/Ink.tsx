/** Fable pulleys copy of mechanics-m42/Ink.tsx: adds the Q glyph only. Shared file left untouched. */
...
Object.assign(G, {
  ...
  'Q': {width:.82,strokes:[[[.42,.05],[.68,.14],[.78,.4],[.7,.74],[.45,.92],[.18,.82],[.06,.55],[.12,.24],[.42,.05]],[[.5,.7],[.8,.98]]]},
});
