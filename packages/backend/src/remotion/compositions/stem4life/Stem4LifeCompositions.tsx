...
import type {BookendProps, IntroBProps, Stem4LifeBookendProps} from './Stem4LifeBookends';
...
const introBSchema = schema.extend({heroHeight: z.number().min(168).max(800).optional()});
