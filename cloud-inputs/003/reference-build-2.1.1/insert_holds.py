...
B17: silent read (3.5 s) between "Read it." and "Look at the word". B20: anchored read (5 s) before
"They credited the reagent", and a 3 s final hold (END) for the held closing frame."""
from pathlib import Path
import json,re,difflib,wave
P=Path(__file__).resolve().parent
H={17:[('Look at the word',3.5)],20:[('They credited the reagent',5),('END',3)]}
