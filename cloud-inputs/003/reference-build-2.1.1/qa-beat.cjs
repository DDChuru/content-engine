...
const P=__dirname,N='/home/dachu/Documents/projects/content-engine/packages/backend/node_modules';module.paths.unshift(N);process.env.NODE_PATH=N;require('module').Module._initPaths();process.env.FONTCONFIG_FILE=P+'/render-cache/fonts.conf';process.env.XDG_CACHE_HOME=P+'/render-cache';process.env.RAYON_NUM_THREADS='3';
