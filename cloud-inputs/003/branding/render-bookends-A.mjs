...
const sourceRoot = '/home/dachu/Documents/projects/content-engine/packages/backend/src/remotion';
...
rmSync(join(publicDir, 'stem4life', 'fonts'), {recursive: true, force: true});
cpSync(join(sourceRoot, 'public/stem4life/fonts'), join(publicDir, 'stem4life/fonts'), {recursive: true});
